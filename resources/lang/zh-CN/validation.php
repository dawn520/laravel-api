...
return [
    ...
    */
    ...
    'alpha_dash'           => '注意: :attribute 只允许字母，数字和_连接符.',
    'alpha_num'            => '注意: :attribute 只允许字母和数字.',
    'alpha_no_chinese'     => '注意: :attribute 只允许字母、数字和 - 和下划线.',
    ...
    'required_if'          => '注意: :attribute 字段必填当 :other 等于 :value.',
