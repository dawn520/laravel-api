 ...
 * Generated for Laravel 5.5.40 on 2018-06-23 18:24:01.
 *
...
namespace Vicens\Captcha\Facades { 
    ...
    class Captcha {
        ...
        {
            return \Vicens\Captcha\Captcha::setConfig($config, $value);
        }
         ...
         * @return string|\Vicens\Captcha\number|array 
         * @static 
         */ 
        public static function getConfig($key = null)
        {
            return \Vicens\Captcha\Captcha::getConfig($key);
        }
        
        /**
         * 生成验证码
         *
         * @return \Vicens\Captcha\Image 
         * @static 
         */ 
        public static function make()
        {
            return \Vicens\Captcha\Captcha::make();
        }
        ...
        {
            return \Vicens\Captcha\Captcha::test($input);
        }
        ...
        {
            return \Vicens\Captcha\Captcha::check($input);
        }
...
namespace  { 
    ...
    class Captcha extends \Vicens\Captcha\Facades\Captcha {}
